<?php
   use App\Propiedad;
    ...
    //debuguear($_SERVER);
   if($_SERVER['SCRIPT_NAME'] === '/bienesraices-poo/anuncios.php'){
...
<div class="contenedor-anuncios">
    ...
    <div class="anuncio">
        <img class="anuncio__imagen" loading="lazy" src="/bienesraices-poo/imagenes/<?php echo $propiedad->imagen; ?>" alt="anuncio">
